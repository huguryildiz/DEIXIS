...
type Route = { view: 'home' } | { view: 'research'; id: string; tab?: string } | { view: 'settings'; tab?: 'connections' } | { view: 'trash' }
...
export default function App() {
  ...
  const crumb = t(route.view === 'settings' ? 'Settings' : route.view === 'trash' ? 'Trash' : route.view === 'research' ? 'Research' : 'New research')
