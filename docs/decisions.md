...
**Status**: accepted (sub-steps 1–2 implemented: removing and restoring a source; trash of tables and templates, undo and the interface are not)
**Date**: 2026-09-16
