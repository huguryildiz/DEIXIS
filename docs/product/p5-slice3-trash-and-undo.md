...
**Tarih:** 16 Eylül 2026. **Durum:** §8'deki yedi soru sahibin yanıtıyla kapandı; her birinde önerilen seçenek seçildi ([D50](../decisions.md)). Kod yazılmadı; §9'daki alt adımlar D45–D49 commit'lendikten sonra başlar. Migration numarası şimdilik `0029` (son dosya `0028_pdf_collection_run_kind.sql`); dilim 2'de olduğu gibi aynı gün başka işe giderse kaydırılır.
