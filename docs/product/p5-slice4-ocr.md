...
- `pdf._join_lines` satır sonu tirelemesini yalnız ASCII küçük harfte birleştiriyor. Bu yüzden "gö-/re" gibi Türkçe tirelemeler ayrık kalıyor; aynı sınır metin katmanı olan dosyalarda da var. Bloklara bölünen satırlar ("dis-/crete", "orman-/cısı") da birleşmiyor.
