...
| 03 | Kayıt türü ve sürüm birleştirme | Kur | Opus · high | dosya hazır | [dilim](sw-slice03-record-kind-and-version-links.md) · [prompt](sw-slice03-prompt.md) | | 127 çiftin gözle denetimi inceleme sohbetinde yapılır (uygulayan yalnızca `pairs.csv` üretir). |
